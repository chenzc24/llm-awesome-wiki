...
$requiredPaths = @(
    ...
    "templates\workspace-kernel\wiki\concepts\README.md",
    "templates\workspace-kernel\wiki\entities\README.md",
    "templates\workspace-kernel\wiki\comparisons\README.md",
    "templates\workspace-kernel\wiki\synthesis\README.md",
    "templates\workspace-kernel\wiki\queries\README.md",
