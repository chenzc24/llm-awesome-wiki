...
def cmd_validate_kernel(args: argparse.Namespace) -> int:
    ...
    required_paths = [
        ...
        "rules/README.md",
        "rules/workflow/maintenance-workflow.md",
        "rules/workflow/distillation-rounds.md",
        "rules/workflow/raw-to-source-packet.md",
        "rules/workflow/source-packet-to-wiki.md",
        "rules/workflow/compare-gate-contract.md",
        "rules/workflow/round-closure-workflow.md",
        "rules/source/extractor-adapter-protocol.md",
        "rules/source/source-type-packet-profiles.md",
        "rules/source/generated-fields-review-routing.md",
        "rules/wiki/wiki-surface-workflow.md",
        "rules/wiki/source-wiki-coverage-protocol.md",
        "rules/claims/evidence-claim-workflow.md",
        "rules/claims/claim-modality-contradiction-review-protocol.md",
        "rules/review/review-queue-workflow.md",
