...
| Phase 3 | Describe evidence and claim workflow. | `rules/claims/evidence-claim-workflow.md` for claim extraction, review routing, and generated-evidence rules. |
| Phase 4 | Describe source-packet-to-wiki workflow. | `rules/wiki/wiki-surface-workflow.md` for page routing, source/chapter templates, index, overview, and wiki log rules. |
